...
public class YKLootTableLoadEvent {
	...
	public void LootTableLoadEvent(LootTableLoadEvent event) {
		...
		if (json_check.equals(json_load)) {
			...
			//resources.assets.yuzukotomod.loot_tables.inject.chests.spawn_bonus_chest.jsonを読み込み
			LootEntryTable leTable = new LootEntryTable(
					new ResourceLocation("yuzukotomod:inject/chests/spawn_bonus_chest"),
					weight,
					quality,
					new LootCondition[0],
					"yuzukotomod_spawn_bonus_chest");
