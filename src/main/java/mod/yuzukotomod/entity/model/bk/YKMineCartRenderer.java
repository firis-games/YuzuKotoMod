package mod.yuzukotomod.entity.model.bk;
...
public class YKMineCartRenderer<T extends YKMineCart> extends Render<T>
{
    ...
    protected ModelBase modelMinecart = new YKMineCartModel();

    public YKMineCartRenderer(RenderManager renderManagerIn)
    {
