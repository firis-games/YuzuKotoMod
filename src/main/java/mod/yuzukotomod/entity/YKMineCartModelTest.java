...
public class YKMineCartModelTest extends ModelBase
{
    public ModelRenderer[] sideModels = new ModelRenderer[7];

    public YKMineCartModelTest()
    {
    	//おそらくテクスチャの表示位置
        ...
        */
        ...
        /*
        this.sideModels[1].addBox(-8.0F, -9.0F, 10.0F, 16, 8, 2, 0.0F);
        this.sideModels[1].setRotationPoint(-9.0F, 4.0F, 0.0F);
        this.sideModels[2].addBox(-8.0F, -9.0F, 10.0F, 16, 8, 2, 0.0F);
        this.sideModels[2].setRotationPoint(9.0F, 4.0F, 0.0F);
        this.sideModels[3].addBox(-8.0F, -9.0F, 10.0F, 16, 8, 2, 0.0F);
        this.sideModels[3].setRotationPoint(0.0F, 4.0F, -7.0F);
        this.sideModels[4].addBox(-8.0F, -9.0F, 10.0F, 16, 8, 2, 0.0F);
        this.sideModels[4].setRotationPoint(0.0F, 4.0F, 7.0F);
        */
