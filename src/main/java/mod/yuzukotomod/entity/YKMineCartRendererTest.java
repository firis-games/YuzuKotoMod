...
public class YKMineCartRendererTest<T extends YKMineCart> extends Render<T>
{
    private static final ResourceLocation MINECART_TEXTURES = new ResourceLocation("textures/entity/minecart.png");
    /** instance of ModelMinecart for rendering */
    protected ModelBase modelMinecart = new YKMineCartModelTest();

    public YKMineCartRendererTest(RenderManager renderManagerIn)
    {
